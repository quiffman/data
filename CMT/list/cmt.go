...
func (c CMT) encode() []string {
	...
	row = append(row, strconv.FormatInt(int64(c.Str1), 16))
	row = append(row, strconv.FormatInt(int64(c.Dp1), 16))
	row = append(row, strconv.FormatInt(int64(c.Rake1), 16))
	row = append(row, strconv.FormatInt(int64(c.Str2), 16))
	row = append(row, strconv.FormatInt(int64(c.Dp2), 16))
	row = append(row, strconv.FormatInt(int64(c.Rake2), 16))
	...
	row = append(row, strconv.FormatInt(int64(c.CD), 16))
	row = append(row, strconv.FormatInt(int64(c.NS), 16))
	row = append(row, strconv.FormatInt(int64(c.DC), 16))
	...
	row = append(row, strconv.FormatInt(int64(c.VR), 16))
	row = append(row, strconv.FormatFloat(float64(c.Tva), 'f', -1, 32))
	row = append(row, strconv.FormatInt(int64(c.Tpl), 16))
	row = append(row, strconv.FormatInt(int64(c.Taz), 16))
	row = append(row, strconv.FormatFloat(float64(c.Nva), 'f', -1, 32))
	row = append(row, strconv.FormatInt(int64(c.Npl), 16))
	row = append(row, strconv.FormatInt(int64(c.Naz), 16))
	row = append(row, strconv.FormatFloat(float64(c.Pva), 'f', -1, 32))
	row = append(row, strconv.FormatInt(int64(c.Ppl), 16))
	row = append(row, strconv.FormatInt(int64(c.Paz), 16))
